...
var Indicator = function(settings) {
  ...
  log.info("Created Alligator indicator with h: ", this.depth);
}
...
Indicator.prototype.update = function(candle) {
	  ...
	  if(this.result === false && this.age < this.depth) {
	    ...
	    this.age++;
	    this.result = false;
	    log.debug("Wait for sufficient age: ", this.age, " out of ", this.depth, "(config.history)"); 
	  ...
	  this.result = this.SSMALips - this.SSMAJaws;
	  return;
	}
...
//Bill Williams Alligator for Gekko
//Extra steps were taken because cannot find proper documentation of the 
//average() function
